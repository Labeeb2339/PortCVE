...
public sealed class SchemaContractTests
{
    ...
    public void GeneratedLockfileShapeMatchesPublishedSchema()
    {
        ...
        AssertSerializedShape(
            ...
            "bindwitness.lock.v1.schema.json");
    }
    ...
    public void PrivateAndRedactedSnapshotShapesMatchPublishedSchema()
    {
        ...
        AssertSerializedShape(
            ...
            "bindwitness.snapshot.v1.schema.json");
        AssertSerializedShape(
    ...
    private static string RepositoryRoot()
    {
        ...
        while (directory is not null && !File.Exists(Path.Combine(directory.FullName, "BindWitness.sln")))
        {
            directory = directory.Parent;
        }

        return directory?.FullName
            ?? throw new DirectoryNotFoundException("Could not locate the BindWitness repository root.");
    }
